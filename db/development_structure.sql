...
CREATE TABLE "chapters" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "parent_id" integer NOT NULL, "parent_type" varchar(255) NOT NULL, "type" varchar(255), "title" varchar(255) NOT NULL, "position" integer NOT NULL, "content" text NOT NULL, "created_at" datetime, "updated_at" datetime);
CREATE TABLE "comments" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "user_id" integer NOT NULL, "commentable_type" varchar(255) NOT NULL, "commentable_id" integer NOT NULL, "vote" integer, "content" text NOT NULL, "created_at" datetime, "updated_at" datetime);
CREATE TABLE "licenses" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "url" varchar(255), "created_at" datetime, "updated_at" datetime);
...
CREATE TABLE "users" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "full_name" varchar(100) DEFAULT '', "email" varchar(100), "image" varchar(255), "description" text, "is_admin" boolean DEFAULT 'f', "login" varchar(40), "crypted_password" varchar(40), "salt" varchar(40), "remember_token" varchar(40), "remember_token_expires_at" datetime, "activation_code" varchar(40), "activated_at" datetime, "state" varchar(255) DEFAULT 'passive', "deleted_at" datetime, "created_at" datetime, "updated_at" datetime);
...
CREATE INDEX "index_chapters_on_parent_id_and_parent_type_and_type" ON "chapters" ("parent_id", "parent_type", "type");
