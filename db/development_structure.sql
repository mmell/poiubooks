...
CREATE TABLE "chapters" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "user_id" integer NOT NULL, "parent_id" integer NOT NULL, "parent_type" varchar(255) NOT NULL, "type" varchar(255), "title" varchar(255) NOT NULL, "position" integer NOT NULL, "content" text NOT NULL, "created_at" datetime, "updated_at" datetime);
CREATE TABLE "comments" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "user_id" integer NOT NULL, "commentable_type" varchar(255) NOT NULL, "commentable_id" integer NOT NULL, "vote" boolean, "content" text NOT NULL, "created_at" datetime, "updated_at" datetime);
