...
describe ChaptersController do
  ...
  describe "GET index" do
    it "assigns all chapters as @chapters" do
      Chapter.stub(:find).with(:all).and_return([mock_chapters])
      get :index
  ...
  describe "GET show" do
    it "assigns the requested chapter as @chapter" do
      Chapter.stub(:find).with("37").and_return(mock_chapters)
      get :show, :id => "37"
  ...
  describe "GET new" do
    it "assigns a new chapter as @chapter" do
      Chapter.stub(:new).and_return(mock_chapters)
      get :new
      assigns[:chapter].should equal(mock_chapters)
    end
  end
  ...
  describe "POST create" do
    ...
    describe "with valid params" do
      it "assigns a newly created chapter as @chapter" do
        Chapter.stub(:new).with({'these' => 'params'}).and_return(mock_chapters(:save => true))
        post :create, :chapter => {:these => 'params'}
        assigns[:chapter].should equal(mock_chapters)
      end

      it "redirects to the created chapter" do
        Chapter.stub(:new).and_return(mock_chapters(:save => true))
        post :create, :chapter => {}
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved chapter as @chapter" do
        Chapter.stub(:new).with({'these' => 'params'}).and_return(mock_chapters(:save => false))
        post :create, :chapter => {:these => 'params'}
        assigns[:chapter].should equal(mock_chapters)
      end

      it "re-renders the 'new' template" do
        Chapter.stub(:new).and_return(mock_chapters(:save => false))
        post :create, :chapter => {}
  ...
  describe "PUT update" do
    ...
    describe "with valid params" do
      ...
      it "assigns the requested chapter as @chapter" do
        Chapter.stub(:find).and_return(mock_chapters(:update_attributes => true))
        put :update, :id => "1"
        assigns[:chapter].should equal(mock_chapters)
      end
